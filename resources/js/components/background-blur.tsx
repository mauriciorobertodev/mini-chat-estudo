export function BackgroundBlur() {
    return (
        <svg
            ...
            className="absolute -left-20 top-0 max-w-[877px] max-h-full text-primary z-10 opacity-50 sm:opacity-85"
            fill="none"
            viewBox="0 0 877 968"
        >
            <g clipPath="url(#a)">
                <circle cx={391} cy={391} r={390.5} stroke="currentColor" transform="matrix(-1 0 0 1 416 -56)" />
                <circle
                    cx={468}
                    cy={468}
                    r={467.5}
